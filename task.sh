...
check_and_update_file() {
  ...
  # 构造请求URL
  local url="https://io.ues.cn/coin/index/taskcheckupdate?ver=$version&file=$filename"
  echo "请求URL: $url"
...
check_file() {
    ...
    result=$(curl -s https://io.ues.cn/coin/index/taskcheckfile)
